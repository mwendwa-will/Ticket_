      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold mb-4">TicketMaster</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/?category=all"><a className="text-gray-400 hover:text-white">All Events</a></Link></li>
                <li><Link href="/?category=concerts"><a className="text-gray-400 hover:text-white">Concerts</a></Link></li>
                <li><Link href="/?category=festivals"><a className="text-gray-400 hover:text-white">Festivals</a></Link></li>
              </ul>
            </div>
